            ...
            <ul class="dropdown-menu" role="menu">
              ...
              <li>
                <a href="tabs_and_accordions.html"
                  ><i class="fa fa-tasks"></i> Tabs &amp; Accordions</a
                >
              </li>
              <li>
              ...
              <li>
                <a href="icons.html"><i class="fa fa-star"></i> Icons</a>
              </li>
              <li>
