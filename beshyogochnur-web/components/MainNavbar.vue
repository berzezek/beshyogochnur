        ...
        <ul class="nav navbar-nav navbar-right">
          ...
          <li class="dropdown">
            ...
            <ul class="dropdown-menu">
              <li v-for="catalog in catalogs?.results" :key="catalog.name">
                <nuxt-link
                  @click="navigateTo(`/catalog/${catalog.slug}`)"
                  id="category-name"
                  >{{ catalog.name }}</nuxt-link
                >
              </li>
            </ul>
          </li>
          ...
          <li class="dropdown">
            ...
            <ul class="dropdown-menu" role="menu">
              <li id="ru">
                <a @click="setLanguage('ru')"
                  ><img src="/images/lang/russia.png" alt="lang" width="24" />
                  Русский</a
                >
              </li>
              <li id="uz">
                <a @click="setLanguage('uz')"
                  ><img
                    src="/images/lang/uzbekistan.png"
                    alt="lang"
                    width="24"
                  />
                  O'zbek</a
              ...
              <li id="en">
                <a @click="setLanguage('en')"
                  ><img
                    src="/images/lang/united-kingdom.png"
                    alt="lang"
                    width="24"
                  />
                  English</a
